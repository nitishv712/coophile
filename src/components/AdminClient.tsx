 ...
 * The catalog editor.
 *
 * The page it sits in has already confirmed the operator is on the admin
 * allowlist and read the catalog out of Mongo, so this starts with the games
 * in hand. Edits still go through the admin API, which re-checks the
 * allowlist server-side — the render-time check decides what to show, never
 * what is allowed.
 */
  ...
  return (
    <main className="flex-grow w-full max-w-screen-xl mx-auto px-6 lg:px-12 py-12 lg:py-16">
      <header className="flex flex-wrap items-end justify-between gap-4 mb-10">
        ...
        <SignOutButton id="btn-admin-signout" className="btn-secondary text-xs px-5 py-2.5">
          Sign out
        </SignOutButton>
      </header>
      ...
      <div className="mb-14">
        ...
        <div className="space-y-6">
          ...
          >
            {pendingFile ? (
              <div className="flex items-center justify-center gap-3 flex-wrap">
                ...
                <span id="pending-file-name" className="font-mono text-sm text-on-surface">
                  {pendingFile.name}
                </span>
              ...
              <>
                ...
                <button type="button" className="btn-secondary text-xs px-6 py-3">
                  Select file
                </button>
              </>
            )}
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="field"
                  value={draft.coop}
                  onChange={(e) => setDraft({ ...draft, coop: e.target.value as CoopMode })}
                >
                  {COOP_MODES.map((mode) => (
          ...
          <section className="card overflow-hidden">
            <details key={editingSlug ?? "new"} open={Boolean(editingSlug)} className="group">
